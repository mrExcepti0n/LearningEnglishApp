...
namespace LearningEnglishWeb.Areas.Training.Controllers
{
    public class CollectWordTrainingController : Controller
    {
        ...
        private readonly CollectWordTrainingFacade _trainingFacade;
        public CollectWordTrainingController(CollectWordTrainingFacade collectWordTrainingFacade)
        {
            _trainingFacade = collectWordTrainingFacade;
        }
